...
- [RAPPORT IHM FINAL](#rapport-ihm-final)
  - [Table des matières](#table-des-matières)
  - [Introduction](#introduction)
  - [2. Accessibilité – Stratégie pour Thierry et Elsa](#2-accessibilité--stratégie-pour-thierry-et-elsa)
    - [2.1 Le ThemeManager : pivot central](#21-le-thememanager--pivot-central)
    - [2.2 Palette adaptée à Thierry (daltonien)](#22-palette-adaptée-à-thierry-daltonien)
    - [2.3 Contraste renforcé pour Elsa](#23-contraste-renforcé-pour-elsa)
    - [2.4 Propagation via WeakReference](#24-propagation-via-weakreference)
    - [2.5 Widgets de paramètres personnalisables](#25-widgets-de-paramètres-personnalisables)
      - [SettingToggleWidget – contrôle granulaire pour Thierry et Elsa](#settingtogglewidget--contrôle-granulaire-pour-thierry-et-elsa)
      - [SettingNavigationWidget – navigation accessible](#settingnavigationwidget--navigation-accessible)
  - [3. Design Système et Cohérence Visuelle](#3-design-système-et-cohérence-visuelle)
    - [3.1 Fondation du design system](#31-fondation-du-design-system)
    - [3.2 Palette unifiée dans les FXML](#32-palette-unifiée-dans-les-fxml)
    - [3.3 Catalogue de composants réutilisables](#33-catalogue-de-composants-réutilisables)
      - [Exemple : `ResourceSummaryRow` – Standardisation du feedback](#exemple--resourcesummaryrow--standardisation-du-feedback)
    - [3.4 Hiérarchie visuelle à trois niveaux](#34-hiérarchie-visuelle-à-trois-niveaux)
      - [ResourceSidebarWidget – La barre de progression comme métaphore universelle](#resourcesidebarwidget--la-barre-de-progression-comme-métaphore-universelle)
      - [SmurfDetailCard – Fiche d’identité structurée](#smurfdetailcard--fiche-didentité-structurée)
      - [AbilityAccordionWidget – Détails masqués par défaut](#abilityaccordionwidget--détails-masqués-par-défaut)
    - [3.5 Cohérence inter-fenêtres](#35-cohérence-inter-fenêtres)
  - [4. Interactions et Flux Utilisateur](#4-interactions-et-flux-utilisateur)
    - [4.1 Feedback textuel immédiat (SaveController)](#41-feedback-textuel-immédiat-savecontroller)
    - [4.2 Sélection explicite avant action (LoadSaveController)](#42-sélection-explicite-avant-action-loadsavecontroller)
    ...
    - [4.5 Mise à jour en temps réel de l’interface](#45-mise-à-jour-en-temps-réel-de-linterface)
    - [4.6 Navigation par pile (AppController)](#46-navigation-par-pile-appcontroller)
    - [4.7 Boutons désactivés contextuellement](#47-boutons-désactivés-contextuellement)
    - [4.8 Verrouillage avec raison textuelle (AbilityAccordionWidget)](#48-verrouillage-avec-raison-textuelle-abilityaccordionwidget)
    - [4.9 Gestion de la défaite sans surprise](#49-gestion-de-la-défaite-sans-surprise)
    - [4.10 Feedback visuel sur l’état de santé (ConsumptionPhaseController)](#410-feedback-visuel-sur-létat-de-santé-consumptionphasecontroller)
  - [5. Conclusion et Perspectives](#5-conclusion-et-perspectives)
    - [5.1 Points forts](#51-points-forts)
    - [5.2 Limites](#52-limites)
    - [5.3 Perspectives d’évolution](#53-perspectives-dévolution)
...
![Capture d’écran : Le ThemeManager avec mode daltonien activé](images/mode_daltonien.png)
...
![Capture d’écran : Palette color-blind appliquée aux ressources dans la sidebar](images/mode_daltonien.png)
...
![Capture d’écran : Exemple de contraste élevé sur un label de statut](images/contraste_eleve.png)
