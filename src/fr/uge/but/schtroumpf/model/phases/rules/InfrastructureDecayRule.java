...
public class InfrastructureDecayRule implements ConsumptionRule {
    ...
    public ConsumptionRuleResult evaluate(SmurfVillage village, int turnNumber) {
        ...
        if (currentTools >= toolsRequired) {
            ...
            appliedEffects.add(new Effect(ResourceType.TOOLS, -toolsRequired));
            ...
            if (currentTools > 0) {
                ...
                appliedEffects.add(new Effect(ResourceType.TOOLS, -currentTools));
            }
            ...
            appliedEffects.add(new Effect(ResourceType.DEFENSE, defensePenalty));
